...
import {
    ...
    // Share,
    // Messages1,
    TaskSquare, NoteText, HambergerMenu,
    Chart21,
    Setting, Messages1
} from 'iconsax-react';


const MenuEmployee = React.memo(({ isSlidebarOpen, taggleSlidebarOpen }) => {
...
MenuEmployee.displayName = "MenuEmployee";

MenuEmployee.propTypes = {
