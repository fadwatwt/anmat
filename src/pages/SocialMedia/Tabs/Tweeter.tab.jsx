    ...
    return (
        <>
            <div className="w-full flex gap-8 flex-wrap dark:bg-gray-900 flex-row">
                <div
                    className="bg-white dark:bg-gray-800 xl:w-8/12 w-full rounded-2xl md:order-1 order-2 py-5 md:px-4 px-0 flex flex-col gap-4 items-start overflow-hidden overflow-x-auto tab-content">
                ...
                <div className={"sm:flex-1 md:order-2 w-[calc(100vw)] order-1 relative"}>
                    <div
                        className={"bg-white dark:bg-gray-800  h-auto rounded-2xl p-4 flex flex-col gap-3 w-full max-h-80 overflow-y-auto none-scroll"}>
